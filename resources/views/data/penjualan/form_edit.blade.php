...
@section('content')
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div>
                <h4 class="content-title mb-2">Form Update Penjualan </h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="pd-10 pd-sm-20 bg-gray-100">
                            <form action="{{ route('data_penjualan.update',$dt->id) }}" method="post">
                                @csrf @method('PUT')
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    ...
                                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                       <input type="date" class="form-control" name="tanggal_penjualan" value="{{ $dt->tanggal_penjualan }}">
                                                    </div>
                                                </div>
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                       <select name="pelanggan_id"  class="form-control select2" id="">
                                                        <option value="{{ $dt->pelanggan_id }}"  selected>{{ $dt->pelanggan->nama_pelanggan }}</option>
