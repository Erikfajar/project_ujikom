...
@section('title', 'data pelanggan') <!-- MENGISI TITLE HALAMAN -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="basic-datatable"
                                class="border-top-0 table-striped  table table-bordered text-nowrap border-bottom">
                                <thead>
                                    <tr>
                                        <th style="text-align: center" class="border-bottom-0">No</th>
                                        <th style="text-align: center" class="border-bottom-0">Nama Pelanggan</th>
                                        <th style="text-align: center" class="border-bottom-0">Alamat</th>
                                        <th style="text-align: center" class="border-bottom-0">No Telp</th>
                                ...
                                <tbody>
                                    @foreach ($pelanggan as $dt)
                                        <tr>
                                            ...
                                            <td style="text-align: center">{{ $dt->nomor_telepon }}</td>
                                            <td style="text-align: center">
                                                    ...
                                                    <form action="{{ route('data_pelanggan.destroy', $dt->id) }}"
                                                        onsubmit="return confirm('yakin mau hapus data?Kalo anda menghapus data ini maka nanti otomatis data yang terkait akan ikut ke hapus')" method="post"
                                                        class="d-inline">
                                                        @csrf @method('DELETE')
