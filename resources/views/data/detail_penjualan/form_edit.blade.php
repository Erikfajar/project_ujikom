...
@section('content')
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div>
                <h4 class="content-title mb-2">Form Update Data Penjualan </h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item text-white active">Data Detail Penjualan</li>
                        <li class="breadcrumb-item text-white active">Form Update</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="pd-10 pd-sm-20 bg-gray-100">
                            <form action="{{ route('detail_penjualan.update',$dt->id) }}" method="post">
                                                ...
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    ...
                                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                        <select onkeyup="sum();" id="produk_id" name="produk_id"
                                                            ...
                                                            <option value="{{ $dt->produk_id }}"  data-harga="{{ $dt->produk->harga }}" selected>{{ $dt->produk->nama_produk }}</option>
                                                ...
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    ...
                                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                        <input class="form-control" onkeyup="sum();" id="jumlah_produk"
                                                            ...
                                                            name="jumlah_produk" value="{{ $dt->jumlah_produk }}">
                                                            <p style="color: red">harap untuk mengetikan ulang angka yang sama/ yang lain</p>
                                                    </div>
                                                </div>
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    <div class="col-md-3">
                                                ...
                                                <div class="row row-xs align-items-center mg-b-20">
                                                    ...
                                                    <div class="col-md-9 mg-t-5 mg-md-t-0">
                                                        <select name="penjualan_id" class="form-control" id="">
                                                            <option value="{{$dt->penjualan_id}}">{{ $dt->penjualan->pelanggan->nama_pelanggan }}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <a href="{{ route('detail_penjualan.show',$dt->penjualan->id) }}"
